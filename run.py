...
def get_args_parser():
    ...
    parser.add_argument('--p-drop', type=float, default=0.0, metavar='PCT', help='Dropout rate (default: 0.)')
    parser.add_argument('--p-sd', type=float, default=0.1, metavar='PCT', help='Stochastic depth rate (default: 0.1)')
    ...
    parser.add_argument('--scheduler-name', default='cosine', type=str, metavar='SCHEDULER', help='LR scheduler (default: "cosine"')
    ...
    # * Mixup params
    parser.add_argument('--mixup-alpha', type=float, default=0.8, help='mixup alpha, mixup enabled if > 0. (default: 0.8)')
    ...
    parser.add_argument('--data-set', default='CIFAR10', choices=['CIFAR10', 'IMNET', 'INAT', 'INAT19', 'two_class_mog'], type=str, help='Image Net dataset path')
