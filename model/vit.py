...
class Attention(nn.Module):
    def __init__(self, dim, heads = 8, dim_head = 64, max_length = 128, causal = False):
        super().__init__()
        ...
        self.causal = causal
        self.register_buffer("mask", torch.tril(torch.ones(max_length, max_length)).view(1, 1, max_length, max_length))
